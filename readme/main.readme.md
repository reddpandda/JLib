...
>
> **Links to:** docs/Onboarding.md ×1, docs/API.md ×1, docs/Architecture.md ×1, docs/Glossary.md ×1, docs/Scope.md ×1, bundles/README.md ×1
...
New to JLib? Start with [docs/Onboarding.md](docs/Onboarding.md) — a
guided first script, step by step. For the full function reference, see
[docs/API.md](docs/API.md). For what each internal component actually
is, see [docs/Glossary.md](docs/Glossary.md). For the rules this
codebase is built on, see [docs/Architecture.md](docs/Architecture.md).
For how the project's scope evolved, see [docs/Scope.md](docs/Scope.md).
